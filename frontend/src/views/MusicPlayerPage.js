            ...
            <div>
                ...
                <p className='f3 bb b--blue red-heading-color w-25 pa1 mt2'>Top Result</p>
                  <article className="hide-child relative ba b--black-20 mw5 ml3">
                    <img src={`https://img.youtube.com/vi/${this.state.song.id}/0.jpg`} className="db w-75 center" alt="Top Result" />
                  ...
                  <Recommendations recommendations={this.state.recommendations} updateMusicComponent={this.updateMusicComponent}/>
                  </div>
                  </section>
            </div>
        );
