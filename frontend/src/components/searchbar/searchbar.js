                ...
                <div className="">
                    <fieldset className="cf bn mw7 mt2">
                        <div className="cf flex">
                            <input className="f6 f5-l input-reset bn fl blue bg-white pa3 lh-solid w-100 w-75-m w-80-l h3 br-pill" placeholder="Search for your song..." type="text" name="song" id="song" onKeyPress={(e)=>{if(e.key === 'Enter') {
